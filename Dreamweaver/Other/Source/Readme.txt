...
user in an INI file next to DreamweaverPortable.exe called DreamweaverPortable.ini.
...
copy DreamweaverPortable.ini from this directory, and paste next to
DreamweaverPortable.exe. 
