...
.styled-table tbody tr { border-bottom: 3px solid #1883ba ; } 
.styled-table tbody tr:nth-of-type(even) { background-color: #f3f3f3; } 
.styled-table tbody tr:last-of-type { border-bottom: 2px solid "orange"; }
</style>
...
echo "<p align = 'left'>";
echo "<img src='logo.png' width='70' height='70'ALIGN=LEFT>";
echo "<h1 ALIGN = 'center'>Reporte integral de compras</h1>"; 
echo "<h2 ALIGN = 'center'>NOMBRE DE LA EMPRESA</h2>";
echo "<h4 ALIGN = 'center'>RFC000000AAA</h4>";
echo "</p>";
echo "</br>";
echo "</br>";
